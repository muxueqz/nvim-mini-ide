...
local function lsp_keymaps(bufnr)
  ...
  keymap("K", "<cmd>lua vim.lsp.buf.hover()<CR>", "Doc")
  keymap("gI", "<cmd>lua vim.lsp.buf.implementation()<CR>", "Go to Implementation")
  keymap("gr", "<cmd>lua vim.lsp.buf.references()<CR>", "Go to References")
  keymap("gl", "<cmd>lua vim.diagnostic.open_float()<CR>", "Show Diagnostic")
end
